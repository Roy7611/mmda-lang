...
> **formatVersion 1.0** · 与 [project-format.md](../project.md)、[diagrams.md](diagrams.md)、[diagram-adapters.md](diagram-adapters.md) 配合使用
...
- [project-format.md](../project.md) — 目录与扩展名
