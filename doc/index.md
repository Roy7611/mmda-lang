...
| 10 | [project.md](project.md) | 项目格式：目录、扩展名、清单、变更日志、归档、多租户 ；**2026-09-25：语言文件统一 `*.m`、目录自由（默认四根 `intents/` `models/` `tests/` `delivery/`）、JSON → M 语言格式、迁移与 6 条待裁见 §11** |
