...
| 26 | [examples/README.md](examples/README.md) | **m 语言示例**（取自 `mmda-mes` 语料的 `Material` / `Bom` / `DailyReport` / `Operation` 及其枚举、状态机；语料即基线 + 字段级 `partitioned` 等价简写） |
