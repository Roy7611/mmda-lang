...
| 21 | [glossary.md](glossary.md) | 术语表（**§3.1 = 事件与集成的唯一命名**：EventSource / Sink / Endpoint / Connector / Channel / Processor 与**禁用别名**；**§3.2 = 易混淆概念辨析**：pub/sub ↔ produce/consume、channel ↔ pipe、**inbound/outbound ↔ inbox/outbox**） |
