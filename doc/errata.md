...
| 24 | **愿景类待裁**：① 规范文本许可最终选型（MIT vs CC-BY-4.0）；② **移动端（多端）** 是否进首版承诺及宿主形态；③ 安全目标是否引入 **OWASP ASVS / Top 10** 作附加硬门禁；~~④ L2 国产化的目标矩阵清单~~ → **✔ 已裁 2026-09-24（1A 2A 3A 4A 5A），矩阵见 §五-18 与 [`vision.md`](vision.md) §5.2.1**；余：**龙芯（LoongArch）何时纳入生产验收**、**申威是否需要**（等客户点名再开）；⑤ 「共赢」是否落成**插件市场 / 伙伴体系** | [`vision.md`](vision.md) **§8**（① ② ③ ⑤ 仍待裁，逐条给建议） |
