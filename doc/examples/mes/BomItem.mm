...
record BomItem {
    ...
    materialId int64? indexed hidden,
    /// 物料编码
    ...
    /// 虚拟件: 是一组物料的组合
    phantom bool default false,
    /// 备件: 设备BOM里面用于备品备件
    sparePart bool default false,
    /// 成本汇总
    costRollup bool default false,
    /// 备注
    remark varchar(255)?,
    /// 引用名称
